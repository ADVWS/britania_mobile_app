                ...
                {userProfile.me.unitsAllowHomecare && userProfile.me.unitsAllowHomecare !== null ? (
                    <View style={[Styles.w100, Styles.p15, Styles.al_center]}>
                        ...
                        <Text style={[{ fontSize: 32 }, Styles.mainFont, Styles.mt20, Styles.text_center, Styles.mainColor_text2]}>
                            {LANGTEXT == 'TH' ? (unitOwner.project ? unitOwner.project.name : null) : (unitOwner.project ? unitOwner.project.nameEng : null)}
                        </Text>
                        <Text style={[Styles.f_24, Styles.mainFont_x, Styles.mt10, Styles.text_center, Styles.gray_text]}>
                            {LANG.homecare_text_02} {unitOwner.houseNumber ? unitOwner.houseNumber : null}
                        </Text>
                        ...
                        <TouchableOpacity onPress={() => { goToHomecare() }} style={[Styles.boxWithShadow, Styles.w100, Styles.p10, Styles.FFF, Styles.br_5, Styles.mt20, Styles.row]}>
                            <View style={[Styles.w20, Styles.p10]}>
                                <Image source={require('../../assets/image/empty_case.png')} style={[{ height: 45, width: 45, tintColor: "#5c5c5c" }]} />
                            </View>
                            ...
                            <View style={[Styles.w20, Styles.jc_center, Styles.al_end]}>
                                <MaterialIcons name="arrow-forward-ios" size={20} color={"#5c5c5c"} />
                            </View>
                        </TouchableOpacity>
                    </View>
                ) : (<>
