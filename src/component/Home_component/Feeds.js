        ...
        <View style={[Styles.w100]}>
            {feeds.map((item) => (
                <TouchableOpacity 
                    ...
                    style={[Styles.w100, Styles.mt15, Styles.boxWithShadow]}>
                    <Image source={{ uri: item.image }} style={[Styles.w100, { height: 170, borderTopLeftRadius: 5, borderTopRightRadius: 5 }]} />
