    ...
    render() {
        return (
            <View>
                ...
                <TouchableOpacity onPress={() => navigate.navigate('MemberManageIndivi')} style={[Styles.boxWithShadow, Styles.w100, Styles.p15, Styles.FFF, Styles.br_5, Styles.mt5, Styles.row]}>
